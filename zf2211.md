...
Selected 'useful' NA vatiables are: target\_death\_rate, -avg\_ann\_count, incidence\_rate, -med\_income, poverty\_percent, -median\_age\_male, -median\_age\_female, pct\_no\_hs18\_24, pct\_hs18\_24, pct\_bach\_deg18\_24, pct\_hs25\_over, pct\_bach\_deg25\_over, pct\_employed16\_over, pct\_unemployed16\_over, pct\_public\_coverage\_alone, pct\_white.
...
```
    ...
    ##     median_age_male + age + pct_employed16_over + pct_white, 
    ##     data = raw_data2)
    ## 
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -147.065  -12.751   -0.216   12.510  127.163 
    ## 
    ## Coefficients:
    ##                      Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)         69.575561   9.569785   7.270 4.59e-13 ***
    ## incidence_rate       0.213215   0.007603  28.045  < 2e-16 ***
    ## poverty_percent      1.291721   0.111104  11.626  < 2e-16 ***
    ## median_age_male     -0.216143   0.095973  -2.252   0.0244 *  
    ## age                  0.790110   0.094339   8.375  < 2e-16 ***
    ## pct_employed16_over -0.758593   0.081027  -9.362  < 2e-16 ***
    ## pct_white            0.040259   0.030058   1.339   0.1805    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 21.25 on 2888 degrees of freedom
    ##   (152 observations deleted due to missingness)
    ## Multiple R-squared:  0.4028, Adjusted R-squared:  0.4016 
    ## F-statistic: 324.7 on 6 and 2888 DF,  p-value: < 2.2e-16
...
```
    ...
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -109.444  -11.830    0.023   11.393  141.973 
    ## 
    ## Coefficients:
    ##                            Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)               50.018202   5.681105   8.804  < 2e-16 ***
    ## pct_bach_deg25_over       -1.537299   0.086344 -17.804  < 2e-16 ***
    ## incidence_rate             0.208342   0.006801  30.632  < 2e-16 ***
    ## poverty_percent            0.795985   0.100679   7.906 3.68e-15 ***
    ## pct_public_coverage_alone  0.326375   0.110543   2.952  0.00318 ** 
    ## pct_unemployed16_over      0.730680   0.148490   4.921 9.08e-07 ***
    ## age                        0.628432   0.083950   7.486 9.26e-14 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 20.03 on 3040 degrees of freedom
    ## Multiple R-squared:   0.48,  Adjusted R-squared:  0.4789 
    ## F-statistic: 467.6 on 6 and 3040 DF,  p-value: < 2.2e-16
